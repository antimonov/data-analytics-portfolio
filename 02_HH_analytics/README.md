...
Так, мы получили наиболее активных работодателей в остальных регионах, что дает представление о географии спроса на аналитиков, исключая влияние столиц. 
...
На рынке труда работодатели активнее всего предлагают именно "Полную занятость" (абсолютное большинство), также лидирует тип графика "Полный рабочий день" - 1,4 тыс. вакансий при полной занятости. С большим отрывом по количеству вакансий следует "удаленный" график - 296 вакансий при полной занятости. 
...
Были выявлены пары наиболее популярных сочетаний типов занятости и графиков работы для каждого популярного работодателя и добавлена средняя минимальная и максимальная зарплата для каждого из них. Отсутствие значения средней максимальной или минимальной зарплаты говорит о том, что работодатель ее не указывает. 
...
Для каждого ключевого навыка проведена оценка, как часто он встречается для каждого конкретного грейда (вне зависимости от того, какой у него приоритет в тексте вакансии). Найдены наиболее востребованные навыки для каждого грейда в каждой категории навыков. При помощи сводной таблицы эти навыки собраны воедино, вне зависимости от того в каком приоритете находился навык и отсортированы по убыванию от самых востребованных до менее востребованных: 
